...
class LinkCompradorMail
{
    ...
    public function template($data)
    {
            ...
            <table width="600" align="center">   
                ...
                <tr>
                    <td style="padding: 0 45px 30px;font-size:16px;font-family:\'Lato\';color:#888888;line-height:20px; width: 510px;">    
                        ' . $data['nombrePasajero'] . ' te envia la/s siguiente/s rifa/s a pagar:<br>
                    </td>    
                </tr>
                <tr>
                    <td>
        ...
        if ($data['business'] == 'ccee') {
            $mail .= '
                    <tr>
                        <td style="padding: 60px 80px 35px; font-size:18px;font-family:\'Lato\', sans-serif;color:#333;line-height:22px; width: 510px; text-align: center; font-family: 600;">
                            El precio de cada rifa es de $4761.
                        </td>
                    </tr>';
        } else if ($data['business'] == 'dtyt') {
            $mail .=
                '
                    <tr>
        ...
        $mail .= '
                <tr>
                    <td style="padding: 0 100px; width: 400px;">
                        <a href="' . $this->link . '/pago/' . $data['token'] . '">
                            <img width="400px" src="' . $this->boton . '">
                        </a>   
                    </td>
                </tr>
                <tr>
                    <td style="padding: 20px 45px 30px;font-size:16px;font-family:\'Lato\';color:#888888;line-height:20px; width: 510px; text-align: center;">    
                        <a href="' . $data['manual'] . '" target="_blank">Aquí te dejamos una breve guía en caso que necesites ayuda para realizar tu pago</a><br>
                    </td>    
                </tr>
                <tr>
