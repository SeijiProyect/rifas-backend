 ...
 */
final class Version20230622002810 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sorteo (id INT AUTO_INCREMENT NOT NULL, rifa_id INT NOT NULL, sorteo_numero INT NOT NULL, numero_inicial_talon INT NOT NULL, cantidad_talones INT NOT NULL, fecha_sorteo DATE NOT NULL, lugar VARCHAR(255) DEFAULT NULL, valor_talon DOUBLE PRECISION DEFAULT NULL, porcentaje_premio DOUBLE PRECISION DEFAULT NULL, INDEX IDX_705F75E0C5884E47 (rifa_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
